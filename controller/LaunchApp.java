...
public class LaunchApp {
	...
	public static void displayGuestInterface(){
	      ...
	      System.out.println("|8. Return to Valet    |");
	  ...
	  public static void displayEmployeeInterface(){
		      ...
		      System.out.println("|8. Remove from valet           |");
		      System.out.println("|9. Show All People In The Hotel|");
	        ...
	        if (selection == 1) {
	            ...
	            while(guest){
	            	...
	            	if(guestChoice == 1){
	            		...
	            		ValetFunctions.requestCar();
	            	}else if(guestChoice == 7){
	            		ValetFunctions.wakeUpCall();
	            	}else if(guestChoice == 8){
	            		ValetFunctions.returnCar();
	            	}else if(guestChoice == 9){
